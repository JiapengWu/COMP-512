...
public class TCPClientHandler {
	...
	public String sendRecvStr(Message msg) throws IOException, IllegalArgumentException {
		...
		BufferedReader input_reader = new BufferedReader(new InputStreamReader(middleware_socket.getInputStream()));
		PrintWriter middleware_writer = new PrintWriter(middleware_socket.getOutputStream(), true);
		middleware_writer.println(msg.toString());
		...
		if (res.equals("<JSONException>"))
			throw new IOException(); // server throws JSON, so it's message transporting exception
		if (res.equals("<IllegalArgumentException>"))
	...
	public boolean deleteFlight(int id, int flightNum) throws IOException, IllegalArgumentException, JSONException {
		Message msg = new Message("deleteFlight");
		msg.delOrQueryFlightCommand(id, flightNum);
		return Boolean.parseBoolean(sendRecvStr(msg));
	}

	public boolean deleteCars(int id, String location) throws IOException, IllegalArgumentException, JSONException {
		Message msg = new Message("deleteCars");
		msg.delOrQueryCommand(id, location);
		return Boolean.parseBoolean(sendRecvStr(msg));
	}

	public boolean deleteRooms(int id, String location) throws IOException, IllegalArgumentException, JSONException {
		Message msg = new Message("deleteRooms");
		msg.delOrQueryCommand(id, location);
		return Boolean.parseBoolean(sendRecvStr(msg));
	}

	public boolean deleteCustomer(int id, int customerID) throws IOException, IllegalArgumentException, JSONException {
		Message msg = new Message("deleteCustomer");
		msg.addDeleteQueryCustomerCommand(id, customerID);
		return Boolean.parseBoolean(sendRecvStr(msg));
	}

	public int queryFlight(int id, int flightNumber) throws IOException, IllegalArgumentException, JSONException {
		Message msg = new Message("queryFlight");
		msg.delOrQueryFlightCommand(id, flightNumber);
		return Integer.parseInt(sendRecvStr(msg));
	}

	public int queryCars(int id, String location) throws IOException, IllegalArgumentException, JSONException {
	...
	public int queryRooms(int id, String location) throws IOException, IllegalArgumentException, JSONException {
	...
	public String queryCustomerInfo(int id, int customerID) throws IOException, IllegalArgumentException {
		Message msg = new Message("queryCustomerInfo");
		msg.addDeleteQueryCustomerCommand(id, customerID);
		return sendRecvStr(msg);
	}

	public int queryFlightPrice(int id, int flightNumber) throws IOException, IllegalArgumentException, JSONException {
		Message msg = new Message("queryFlightPrice");
		msg.delOrQueryFlightCommand(id, flightNumber);
		return Integer.parseInt(sendRecvStr(msg));
	}

	public int queryCarsPrice(int id, String location) throws IOException, IllegalArgumentException, JSONException {
		Message msg = new Message("queryCarsPrice");
		msg.delOrQueryCommand(id, location);
		return Integer.parseInt(sendRecvStr(msg));
	}

	public int queryRoomsPrice(int id, String location) throws IOException, IllegalArgumentException, JSONException {
	...
	public boolean reserveCar(int id, int customerID, String location) throws IOException, IllegalArgumentException {
		Message msg = new Message("reserveCar");
		msg.reserveCommand(id, customerID, location);
		return Boolean.parseBoolean(sendRecvStr(msg));
	}

	public boolean reserveRoom(int id, int customerID, String location) throws IOException, IllegalArgumentException {
	...
	public boolean bundle(int id, int customerID, Vector<String> flightNumbers, String location, boolean car,
			boolean room) throws IOException, IllegalArgumentException {
		Message msg = new Message("bundle");
		msg.bundleCommand(id, customerID, flightNumbers, location, car, room);
		return Boolean.parseBoolean(sendRecvStr(msg));
	}
	
	public String queryFlightSummary(int id)throws IOException, IllegalArgumentException, JSONException {
		Message msg = new Message("queryFlightSummary");
		msg.summaryCommand(id);
		return sendRecvStr(msg);
	}
	
	public String queryRoomsSummary(int id) throws IOException, IllegalArgumentException, JSONException {
		Message msg = new Message("queryRoomsSummary");
		msg.summaryCommand(id);
		return sendRecvStr(msg);
	}
	
	public String queryCarsSummary(int id) throws IOException, IllegalArgumentException, JSONException {
		Message msg = new Message("queryCarsSummary");
		msg.summaryCommand(id);
		return sendRecvStr(msg);
	}
	
	public String queryCustomerSummary(int id) throws IOException, IllegalArgumentException, JSONException{
		Message msg = new Message("queryCustomerSummary");
		msg.summaryCommand(id);
		return sendRecvStr(msg);
	}
